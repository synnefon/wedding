...
`}),c}function ws(i,c,u){t:{for(f in u){var f=!1;break t}f=!0}f||(u=Ao(u),typeof i=="string"?u!=null&&vn(u):rt(i,c,u))}function lt(i){ot.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}E(lt,ot);var gl=/^https?$/i,_l=["POST","PUT"];n=lt.prototype,n.Fa=function(i){this.H=i},n.ea=function(i,c,u,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);c=c?c.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():so.g(),this.g.onreadystatechange=w(d(this.Ca,this));try{this.B=!0,this.g.open(c,String(i),!0),this.B=!1}catch(R){bo(this,R);return}if(i=u||"",u=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var A in f)u.set(A,f[A]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const R of f.keys())u.set(R,f.get(R));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(u.keys()).find(R=>R.toLowerCase()=="content-type"),A=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(_l,c,void 0)>=0)||f||A||u.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,D]of u)this.g.setRequestHeader(R,D);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch(R){bo(this,R)}};function bo(i,c){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=c,i.o=5,Ro(i),lr(i)}function Ro(i){i.A||(i.A=!0,dt(i,"complete"),dt(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,dt(this,"complete"),dt(this,"abort"),lr(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),lr(this,!0)),lt.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?So(this):this.Xa())},n.Xa=function(){So(this)};function So(i){if(i.h&&typeof o<"u"){if(i.v&&ue(i)==4)setTimeout(i.Ca.bind(i),0);else if(dt(i,"readystatechange"),ue(i)==4){i.h=!1;try{const R=i.ca();t:switch(R){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break t;default:c=!1}var u;if(!(u=c)){var f;if(f=R===0){let D=String(i.D).match(go)[1]||null;!D&&a.self&&a.self.location&&(D=a.self.location.protocol.slice(0,-1)),f=!gl.test(D?D.toLowerCase():"")}u=f}if(u)dt(i,"complete"),dt(i,"success");else{i.o=6;try{var A=ue(i)>2?i.g.statusText:""}catch{A=""}i.l=A+" ["+i.ca()+"]",Ro(i)}}finally{lr(i)}}}}function lr(i,c){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const u=i.g;i.g=null,c||dt(i,"ready");try{u.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function ue(i){return i.g?i.g.readyState:0}n.ca=function(){try{return ue(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(i){if(this.g){var c=this.g.responseText;return i&&c.indexOf(i)==0&&(c=c.substring(i.length)),Xu(c)}};function Co(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function yl(i){const c={};i=(i.g&&ue(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<i.length;f++){if(g(i[f]))continue;var u=nl(i[f]);const A=u[0];if(u=u[1],typeof u!="string")continue;u=u.trim();const R=c[A]||[];c[A]=R,R.push(u)}us(c,function(f){return f.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Pn(i,c,u){return u&&u.internalChannelParams&&u.internalChannelParams[i]||c}function Po(i){this.za=0,this.i=[],this.j=new En,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Pn("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Pn("baseRetryDelayMs",5e3,i),this.Za=Pn("retryDelaySeedMs",1e4,i),this.Ta=Pn("forwardChannelMaxRetries",2,i),this.va=Pn("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new lo(i&&i.concurrentRequestLimit),this.Ba=new pl,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=Po.prototype,n.ka=8,n.I=1,n.connect=function(i,c,u,f){Vt(0),this.W=i,this.H=c||{},u&&f!==void 0&&(this.H.OSID=u,this.H.OAID=f),this.F=this.X,this.J=Fo(this,null,this.W),dr(this)};function Is(i){if(Vo(i),i.I==3){var c=i.V++,u=Ht(i.J);if(rt(u,"SID",i.M),rt(u,"RID",c),rt(u,"TYPE","terminate"),Vn(i,u),c=new oe(i,i.j,c),c.M=2,c.A=cr(Ht(u)),u=!1,a.navigator&&a.navigator.sendBeacon)try{u=a.navigator.sendBeacon(c.A.toString(),"")}catch{}!u&&a.Image&&(new Image().src=c.A,u=!0),u||(c.g=Bo(c.j,null),c.g.ea(c.A)),c.F=Date.now(),ar(c)}Oo(i)}function hr(i){i.g&&(bs(i),i.g.cancel(),i.g=null)}function Vo(i){hr(i),i.v&&(a.clearTimeout(i.v),i.v=null),fr(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function dr(i){if(!ho(i.h)&&!i.m){i.m=!0;var c=i.Ea;_t||p(),ct||(_t(),ct=!0),T.add(c,i),i.D=0}}function El(i,c){return fo(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=c.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=yn(d(i.Ea,i,c),Mo(i,i.D)),i.D++,!0)}n.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const A=new oe(this,this.j,i);let R=this.o;if(this.U&&(R?(R=q(R),W(R,this.U)):R=this.U),this.u!==null||this.R||(A.J=R,R=null),this.S)t:{for(var c=0,u=0;u<this.i.length;u++){e:{var f=this.i[u];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break e}f=void 0}if(f===void 0)break;if(c+=f,c>4096){c=u;break t}if(c===4096||u===this.i.length-1){c=u+1;break t}}c=1e3}else c=1e3;c=No(this,A,c),u=Ht(this.J),rt(u,"RID",i),rt(u,"CVER",22),this.G&&rt(u,"X-HTTP-Session-Id",this.G),Vn(this,u),R&&(this.R?c="headers="+vn(Ao(R))+"&"+c:this.u&&ws(u,this.u,R)),Es(this.h,A),this.Ra&&rt(u,"TYPE","init"),this.S?(rt(u,"$req",c),rt(u,"SID","null"),A.U=!0,ps(A,u,null)):ps(A,u,c),this.I=2}}else this.I==3&&(i?Do(this,i):this.i.length==0||ho(this.h)||Do(this))};function Do(i,c){var u;c?u=c.l:u=i.V++;const f=Ht(i.J);rt(f,"SID",i.M),rt(f,"RID",u),rt(f,"AID",i.K),Vn(i,f),i.u&&i.o&&ws(f,i.u,i.o),u=new oe(i,i.j,u,i.D+1),i.u===null&&(u.J=i.o),c&&(i.i=c.G.concat(i.i)),c=No(i,u,1e3),u.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),Es(i.h,u),ps(u,f,c)}function Vn(i,c){i.H&&Se(i.H,function(u,f){rt(c,f,u)}),i.l&&Se({},function(u,f){rt(c,f,u)})}function No(i,c,u){u=Math.min(i.i.length,u);const f=i.l?d(i.l.Ka,i.l,i):null;t:{var A=i.i;let z=-1;for(;;){const yt=["count="+u];z==-1?u>0?(z=A[0].g,yt.push("ofs="+z)):z=0:yt.push("ofs="+z);let et=!0;for(let Tt=0;Tt<u;Tt++){var R=A[Tt].g;const Gt=A[Tt].map;if(R-=z,R<0)z=Math.max(0,A[Tt].g-100),et=!1;else try{R="req"+R+"_"||"";try{var D=Gt instanceof Map?Gt:Object.entries(Gt);for(const[Ne,le]of D){let he=le;l(le)&&(he=ls(le)),yt.push(R+Ne+"="+encodeURIComponent(he))}}catch(Ne){throw yt.push(R+"type="+encodeURIComponent("_badmap")),Ne}}catch{f&&f(Gt)}}if(et){D=yt.join("&");break t}}D=void 0}return i=i.i.splice(0,u),c.G=i,D}function ko(i){if(!i.g&&!i.v){i.Y=1;var c=i.Da;_t||p(),ct||(_t(),ct=!0),T.add(c,i),i.A=0}}function As(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=yn(d(i.Da,i),Mo(i,i.A)),i.A++,!0)}n.Da=function(){if(this.v=null,xo(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=yn(d(this.Wa,this),i)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Vt(10),hr(this),xo(this))};function bs(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function xo(i){i.g=new oe(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var c=Ht(i.na);rt(c,"RID","rpc"),rt(c,"SID",i.M),rt(c,"AID",i.K),rt(c,"CI",i.F?"0":"1"),!i.F&&i.ia&&rt(c,"TO",i.ia),rt(c,"TYPE","xmlhttp"),Vn(i,c),i.u&&i.o&&ws(c,i.u,i.o),i.O&&(i.g.H=i.O);var u=i.g;i=i.ba,u.M=1,u.A=cr(Ht(c)),u.u=null,u.R=!0,ao(u,i)}n.Va=function(){this.C!=null&&(this.C=null,hr(this),As(this),Vt(19))};function fr(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function Lo(i,c){var u=null;if(i.g==c){fr(i),bs(i),i.g=null;var f=2}else if(ys(i.h,c))u=c.G,mo(i.h,c),f=1;else return;if(i.I!=0){if(c.o)if(f==1){u=c.u?c.u.length:0,c=Date.now()-c.F;var A=i.D;f=ir(),dt(f,new no(f,u)),dr(i)}else ko(i);else if(A=c.m,A==3||A==0&&c.X>0||!(f==1&&El(i,c)||f==2&&As(i)))switch(u&&u.length>0&&(c=i.h,c.i=c.i.concat(u)),A){case 1:De(i,5);break;case 4:De(i,10);break;case 3:De(i,6);break;default:De(i,2)}}}function Mo(i,c){let u=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(u*=2),u*c}function De(i,c){if(i.j.info("Error code "+c),c==2){var u=d(i.bb,i),f=i.Ua;const A=!f;f=new ae(f||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||wn(f,"https"),cr(f),A?fl(f.toString(),u):ml(f.toString(),u)}else Vt(2);i.I=0,i.l&&i.l.pa(c),Oo(i),Vo(i)}n.bb=function(i){i?(this.j.info("Successfully pinged google.com"),Vt(2)):(this.j.info("Failed to ping google.com"),Vt(1))};function Oo(i){if(i.I=0,i.ja=[],i.l){const c=po(i.h);(c.length!=0||i.i.length!=0)&&(V(i.ja,c),V(i.ja,i.i),i.h.i.length=0,b(i.i),i.i.length=0),i.l.oa()}}function Fo(i,c,u){var f=u instanceof ae?Ht(u):new ae(u);if(f.g!="")c&&(f.g=c+"."+f.g),In(f,f.u);else{var A=a.location;f=A.protocol,c=c?c+"."+A.hostname:A.hostname,A=+A.port;const R=new ae(null);f&&wn(R,f),c&&(R.g=c),A&&In(R,A),u&&(R.h=u),f=R}return u=i.G,c=i.wa,u&&c&&rt(f,u,c),rt(f,"VER",i.ka),Vn(i,f),f}function Bo(i,c,u){if(c&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=i.Aa&&!i.ma?new lt(new Ts({ab:u})):new lt(i.ma),c.Fa(i.L),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Uo(){}n=Uo.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function mr(){}mr.prototype.g=function(i,c){return new xt(i,c)};function xt(i,c){ot.call(this),this.g=new Po(c),this.l=i,this.h=c&&c.messageUrlParams||null,i=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(i?i["X-WebChannel-Content-Type"]=c.messageContentType:i={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(i?i["X-WebChannel-Client-Profile"]=c.sa:i={"X-WebChannel-Client-Profile":c.sa}),this.g.U=i,(i=c&&c.Qb)&&!g(i)&&(this.g.u=i),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!g(c)&&(this.g.G=c,i=this.h,i!==null&&c in i&&(i=this.h,c in i&&delete i[c])),this.j=new Ge(this)}E(xt,ot),xt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},xt.prototype.close=function(){Is(this.g)},xt.prototype.o=function(i){var c=this.g;if(typeof i=="string"){var u={};u.__data__=i,i=u}else this.v&&(u={},u.__data__=ls(i),i=u);c.i.push(new il(c.Ya++,i)),c.I==3&&dr(c)},xt.prototype.N=function(){this.g.l=null,delete this.j,Is(this.g),delete this.g,xt.Z.N.call(this)};function qo(i){hs.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var c=i.__sm__;if(c){t:{for(const u in c){i=u;break t}i=void 0}(this.i=i)&&(i=this.i,c=c!==null&&i in c?c[i]:void 0),this.data=c}else this.data=i}E(qo,hs);function $o(){ds.call(this),this.status=1}E($o,ds);function Ge(i){this.g=i}E(Ge,Uo),Ge.prototype.ra=function(){dt(this.g,"a")},Ge.prototype.qa=function(i){dt(this.g,new qo(i))},Ge.prototype.pa=function(i){dt(this.g,new $o)},Ge.prototype.oa=function(){dt(this.g,"b")},mr.prototype.createWebChannel=mr.prototype.g,xt.prototype.send=xt.prototype.o,xt.prototype.open=xt.prototype.m,xt.prototype.close=xt.prototype.close,Tc=function(){return new mr},vc=function(){return ir()},Ec=Ce,$s={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},or.NO_ERROR=0,or.TIMEOUT=8,or.HTTP_ERROR=6,Ar=or,ro.COMPLETE="complete",yc=ro,Ji.EventType=gn,gn.OPEN="a",gn.CLOSE="b",gn.ERROR="c",gn.MESSAGE="d",ot.prototype.listen=ot.prototype.J,Dn=Ji,lt.prototype.listenOnce=lt.prototype.K,lt.prototype.getLastError=lt.prototype.Ha,lt.prototype.getLastErrorCode=lt.prototype.ya,lt.prototype.getStatus=lt.prototype.ca,lt.prototype.getResponseJson=lt.prototype.La,lt.prototype.getResponseText=lt.prototype.la,lt.prototype.send=lt.prototype.ea,lt.prototype.setWithCredentials=lt.prototype.Fa,_c=lt}).apply(typeof gr<"u"?gr:typeof self<"u"?self:typeof window<"u"?window:{});const ea="@firebase/firestore",na="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pc="server_timestamp",Vc="__type__",Dc="__previous_value__",Nc="__local_write_time__";function di(n){return(n?.mapValue?.fields||{})[Vc]?.stringValue===Pc}function Kr(n){const t=n.mapValue.fields[Dc];return di(t)?Kr(t):t}function Hn(n){const t=ye(n.mapValue.fields[Nc].timestampValue);return new st(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zr{constructor(t,e,r,s,o){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(t,e,r){const s=new Map;return s.set(t,Zn.createSynthesizedTargetChangeForCurrentChange(t,e,r)),new Zr(F.min(),s,new at(K),re(),Q())}}class Zn{constructor(t,e,r,s,o){this.resumeToken=t,this.current=e,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(t,e,r){return new Zn(r,e,Q(),Q(),Q())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bf{constructor(t,e,r,s){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=r,this.indexManager=s}getDocument(t,e){let r=null;return this.documentOverlayCache.getOverlay(t,e).next((s=>(r=s,this.remoteDocumentCache.getEntry(t,e)))).next((s=>(r!==null&&Un(r.mutation,s,Lt.empty(),st.now()),s)))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next((r=>this.getLocalViewOfDocuments(t,r,Q()).next((()=>r))))}getLocalViewOfDocuments(t,e,r=Q()){const s=xe();return this.populateOverlays(t,s,e).next((()=>this.computeViews(t,e,s,r).next((o=>{let a=Nn();return o.forEach(((l,h)=>{a=a.insert(l,h.overlayedDocument)})),a}))))}getOverlayedDocuments(t,e){const r=xe();return this.populateOverlays(t,r,e).next((()=>this.computeViews(t,e,r,Q())))}populateOverlays(t,e,r){const s=[];return r.forEach((o=>{e.has(o)||s.push(o)})),this.documentOverlayCache.getOverlays(t,s).next((o=>{o.forEach(((a,l)=>{e.set(a,l)}))}))}computeViews(t,e,r,s){let o=re();const a=Bn(),l=(function(){return Bn()})();return e.forEach(((h,d)=>{const m=r.get(d.key);s.has(d.key)&&(m===void 0||m.mutation instanceof be)?o=o.insert(d.key,d):m!==void 0?(a.set(d.key,m.mutation.getFieldMask()),Un(m.mutation,d,m.mutation.getFieldMask(),st.now())):a.set(d.key,Lt.empty())})),this.recalculateAndSaveOverlays(t,o).next((h=>(h.forEach(((d,m)=>a.set(d,m))),e.forEach(((d,m)=>l.set(d,new Ff(m,a.get(d)??null)))),l)))}recalculateAndSaveOverlays(t,e){const r=Bn();let s=new at(((a,l)=>a-l)),o=Q();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next((a=>{for(const l of a)l.keys().forEach((h=>{const d=e.get(h);if(d===null)return;let m=r.get(h)||Lt.empty();m=l.applyToLocalView(d,m),r.set(h,m);const E=(s.get(l.batchId)||Q()).add(h);s=s.insert(l.batchId,E)}))})).next((()=>{const a=[],l=s.getReverseIterator();for(;l.hasNext();){const h=l.getNext(),d=h.key,m=h.value,E=Kc();m.forEach((w=>{if(!o.has(w)){const b=tu(e.get(w),r.get(w));b!==null&&E.set(w,b),o=o.add(w)}})),a.push(this.documentOverlayCache.saveOverlays(t,d,E))}return C.waitFor(a)})).next((()=>r))}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next((r=>this.recalculateAndSaveOverlays(t,r)))}getDocumentsMatchingQuery(t,e,r,s){return(function(a){return M.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0})(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):$c(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,r,s):this.getDocumentsMatchingCollectionQuery(t,e,r,s)}getNextDocuments(t,e,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,r,s).next((o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,r.largestBatchId,s-o.size):C.resolve(xe());let l=zn,h=o;return a.next((d=>C.forEach(d,((m,E)=>(l<E.largestBatchId&&(l=E.largestBatchId),o.get(m)?C.resolve():this.remoteDocumentCache.getEntry(t,m).next((w=>{h=h.insert(m,w)}))))).next((()=>this.populateOverlays(t,d,o))).next((()=>this.computeViews(t,h,d,Q()))).next((m=>({batchId:l,changes:Gc(m)})))))}))}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new M(e)).next((r=>{let s=Nn();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s}))}getDocumentsMatchingCollectionGroupQuery(t,e,r,s){const o=e.collectionGroup;let a=Nn();return this.indexManager.getCollectionParents(t,o).next((l=>C.forEach(l,(h=>{const d=(function(E,w){return new hn(w,null,E.explicitOrderBy.slice(),E.filters.slice(),E.limit,E.limitType,E.startAt,E.endAt)})(e,h.child(o));return this.getDocumentsMatchingCollectionQuery(t,d,r,s).next((m=>{m.forEach(((E,w)=>{a=a.insert(E,w)}))}))})).next((()=>a))))}getDocumentsMatchingCollectionQuery(t,e,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,r.largestBatchId).next((a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,r,o,s)))).next((a=>{o.forEach(((h,d)=>{const m=d.getKey();a.get(m)===null&&(a=a.insert(m,Pt.newInvalidDocument(m)))}));let l=Nn();return a.forEach(((h,d)=>{const m=o.get(h);m!==void 0&&Un(m.mutation,d,Lt.empty(),st.now()),Xr(e,d)&&(l=l.insert(h,d))})),l}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const St="WebChannelConnection";class lm extends cm{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,r,s,o){const a=ei();return new Promise(((l,h)=>{const d=new _c;d.setWithCredentials(!0),d.listenOnce(yc.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Ar.NO_ERROR:const E=d.getResponseJson();x(St,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(E)),l(E);break;case Ar.TIMEOUT:x(St,`RPC '${t}' ${a} timed out`),h(new k(S.DEADLINE_EXCEEDED,"Request time out"));break;case Ar.HTTP_ERROR:const w=d.getStatus();if(x(St,`RPC '${t}' ${a} failed with status:`,w,"response text:",d.getResponseText()),w>0){let b=d.getResponseJson();Array.isArray(b)&&(b=b[0]);const V=b?.error;if(V&&V.status&&V.message){const N=(function(U){const j=U.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(j)>=0?j:S.UNKNOWN})(V.status);h(new k(N,V.message))}else h(new k(S.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new k(S.UNAVAILABLE,"Connection failed."));break;default:O(9055,{l_:t,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{x(St,`RPC '${t}' ${a} completed.`)}}));const m=JSON.stringify(s);x(St,`RPC '${t}' ${a} sending request:`,s),d.send(e,"POST",m,r,15)}))}T_(t,e,r){const s=ei(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=Tc(),l=vc(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.jo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");x(St,`Creating RPC '${t}' stream ${s}: ${m}`,h);const E=a.createWebChannel(m,h);this.I_(E);let w=!1,b=!1;const V=new um({Yo:P=>{b?x(St,`Not sending because RPC '${t}' stream ${s} is closed:`,P):(w||(x(St,`Opening RPC '${t}' stream ${s} transport.`),E.open(),w=!0),x(St,`RPC '${t}' stream ${s} sending:`,P),E.send(P))},Zo:()=>E.close()}),N=(P,U,j)=>{P.listen(U,(H=>{try{j(H)}catch(J){setTimeout((()=>{throw J}),0)}}))};return N(E,Dn.EventType.OPEN,(()=>{b||(x(St,`RPC '${t}' stream ${s} transport opened.`),V.o_())})),N(E,Dn.EventType.CLOSE,(()=>{b||(b=!0,x(St,`RPC '${t}' stream ${s} transport closed`),V.a_(),this.E_(E))})),N(E,Dn.EventType.ERROR,(P=>{b||(b=!0,Ze(St,`RPC '${t}' stream ${s} transport errored. Name:`,P.name,"Message:",P.message),V.a_(new k(S.UNAVAILABLE,"The operation could not be completed")))})),N(E,Dn.EventType.MESSAGE,(P=>{if(!b){const U=P.data[0];tt(!!U,16349);const j=U,H=j?.error||j[0]?.error;if(H){x(St,`RPC '${t}' stream ${s} received error:`,H);const J=H.status;let _t=(function(p){const _=mt[p];if(_!==void 0)return ru(_)})(J),ct=H.message;_t===void 0&&(_t=S.INTERNAL,ct="Unknown error status: "+J+" with message "+H.message),b=!0,V.a_(new k(_t,ct)),E.close()}else x(St,`RPC '${t}' stream ${s} received:`,U),V.u_(U)}})),N(l,Ec.STAT_EVENT,(P=>{P.stat===$s.PROXY?x(St,`RPC '${t}' stream ${s} detected buffering proxy`):P.stat===$s.NOPROXY&&x(St,`RPC '${t}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{V.__()}),0),V}terminate(){this.c_.forEach((t=>t.close())),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter((e=>e===t))}}function xs(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{static emptySet(t){return new Je(t.comparator)}constructor(t){this.comparator=t?(e,r)=>t(e,r)||M.comparator(e.key,r.key):(e,r)=>M.comparator(e.key,r.key),this.keyedMap=Nn(),this.sortedSet=new at(this.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal(((e,r)=>(t(e),!1)))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof Je)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(!s.isEqual(o))return!1}return!0}toString(){const t=[];return this.forEach((e=>{t.push(e.toString())})),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Re{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new Re(this.firestore,t,this._query)}}class ht{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new ge(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new ht(this.firestore,t,this._key)}toJSON(){return{type:ht._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,e,r){if(Yn(e,ht._jsonSchema))return new ht(t,r||null,new M(nt.fromString(e.referencePath)))}}ht._jsonSchemaVersion="firestore/documentReference/1.0",ht._jsonSchema={type:gt("string",ht._jsonSchemaVersion),referencePath:gt("string")};class ge extends Re{constructor(t,e,r){super(t,e,Qr(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new ht(this.firestore,null,new M(t))}withConverter(t){return new ge(this.firestore,t,this._path)}}function Tr(n,t,...e){if(n=Jt(n),Ac("collection","path",t),n instanceof rs){const r=nt.fromString(t,...e);return oa(r),new ge(n,null,r)}{if(!(n instanceof ht||n instanceof ge))throw new k(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(nt.fromString(t,...e));return oa(r),new ge(n.firestore,null,r)}}function xn(n,t,...e){if(n=Jt(n),arguments.length===1&&(t=li.newId()),Ac("doc","path",t),n instanceof rs){const r=nt.fromString(t,...e);return ia(r),new ht(n,null,new M(r))}{if(!(n instanceof ht||n instanceof ge))throw new k(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(nt.fromString(t,...e));return ia(r),new ht(n.firestore,n instanceof ge?n.converter:null,new M(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class is{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new k(S.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new bt(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xt{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new k(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new k(S.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return K(this._lat,t._lat)||K(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Xt._jsonSchemaVersion}}static fromJSON(t){if(Yn(t,Xt._jsonSchema))return new Xt(t.latitude,t.longitude)}}Xt._jsonSchemaVersion="firestore/geoPoint/1.0",Xt._jsonSchema={type:gt("string",Xt._jsonSchemaVersion),latitude:gt("number"),longitude:gt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yt{constructor(t){this._values=(t||[]).map((e=>e))}toArray(){return this._values.map((t=>t))}isEqual(t){return(function(r,s){if(r.length!==s.length)return!1;for(let o=0;o<r.length;++o)if(r[o]!==s[o])return!1;return!0})(this._values,t._values)}toJSON(){return{type:Yt._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(t){if(Yn(t,Yt._jsonSchema)){if(Array.isArray(t.vectorValues)&&t.vectorValues.every((e=>typeof e=="number")))return new Yt(t.vectorValues);throw new k(S.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Yt._jsonSchemaVersion="firestore/vectorValue/1.0",Yt._jsonSchema={type:gt("string",Yt._jsonSchemaVersion),vectorValues:gt("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function pp(n){n=Mt(n,ht);const t=Mt(n.firestore,Ie);return Zm(ss(t),n._key).then((e=>Ku(t,n,e)))}Me._jsonSchemaVersion="firestore/querySnapshot/1.0",Me._jsonSchema={type:gt("string",Me._jsonSchemaVersion),bundleSource:gt("string","QuerySnapshot"),bundleName:gt("string"),bundle:gt("string")};class Gi extends fp{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ft(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new ht(this.firestore,null,e)}}function gp(n){n=Mt(n,Re);const t=Mt(n.firestore,Ie),e=ss(t),r=new Gi(t);return ju(n._query),tp(e,n._query).then((s=>new Me(t,r,n,s)))}function ec(n,t,e){n=Mt(n,ht);const r=Mt(n.firestore,Ie),s=Gu(n.converter,t);return Ki(r,[Fu(as(r),"setDoc",n._key,s,n.converter!==null,e).toMutation(n._key,Ut.none())])}function _p(n,t,e,...r){n=Mt(n,ht);const s=Mt(n.firestore,Ie),o=as(s);let a;return a=typeof(t=Jt(t))=="string"||t instanceof is?up(o,"updateDoc",n._key,t,e,r):cp(o,"updateDoc",n._key,t),Ki(s,[a.toMutation(n._key,Ut.exists(!0))])}function yp(n,t){const e=Mt(n.firestore,Ie),r=xn(n),s=Gu(n.converter,t);return Ki(e,[Fu(as(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,Ut.exists(!1))]).then((()=>r))}function nc(n,...t){n=Jt(n);let e={includeMetadataChanges:!1,source:"default"},r=0;typeof t[r]!="object"||Ya(t[r])||(e=t[r++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(Ya(t[r])){const h=t[r];t[r]=h.next?.bind(h),t[r+1]=h.error?.bind(h),t[r+2]=h.complete?.bind(h)}let o,a,l;if(n instanceof ht)a=Mt(n.firestore,Ie),l=Qr(n._key.path),o={next:h=>{t[r]&&t[r](Ku(a,n,h))},error:t[r+1],complete:t[r+2]};else{const h=Mt(n,Re);a=Mt(h.firestore,Ie),l=h._query;const d=new Gi(a);o={next:m=>{t[r]&&t[r](new Me(a,d,h,m))},error:t[r+1],complete:t[r+2]},ju(n._query)}return(function(d,m,E,w){const b=new Mi(w),V=new ki(m,b,E);return d.asyncQueue.enqueueAndForget((async()=>Vi(await $r(d),V))),()=>{b.Nu(),d.asyncQueue.enqueueAndForget((async()=>Di(await $r(d),V)))}})(ss(a),l,s,o)}function Ki(n,t){return(function(r,s){const o=new te;return r.asyncQueue.enqueueAndForget((async()=>qm(await Jm(r),s,o))),o.promise})(ss(n),t)}function Ku(n,t,e){const r=e.docs.get(t._key),s=new Gi(n);return new Le(n,s,t._key,r,new Ln(e.hasPendingWrites,e.fromCache),t.converter)}function Ep(){return new Oi("serverTimestamp")}function vp(...n){return new Fi("arrayUnion",n)}(function(t,e=!0){(function(s){cn=s})(Hh),Nr(new $n("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),l=new Ie(new ad(r.getProvider("auth-internal")),new ld(a,r.getProvider("app-check-internal")),(function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new k(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Gn(d.options.projectId,m)})(a,s),a);return o={useFetchStreams:e,...o},l._setSettings(o),l}),"PUBLIC").setMultipleInstances(!0)),Ye(ea,na,t),Ye(ea,na,"esm2020")})();const Tp={apiKey:"AIzaSyC_JekFZUQ5xpp33viYesstWMWW1IWrjPs",authDomain:"wedding-d16cc.firebaseapp.com",projectId:"wedding-d16cc",storageBucket:"wedding-d16cc.firebasestorage.app",messagingSenderId:"398999128995",appId:"1:398999128995:web:8f76adc5172ba04dbe6816",measurementId:"G-7BZV4Q5649"};class wp{db;constructor(){const t=fc(Tp);this.db=np(t)}async addRsvp(t){const e=(t.firstName||"").trim().toLowerCase().replace(/\s+/g,"_"),r=(t.lastName||"").trim().toLowerCase().replace(/\s+/g,"_"),s=e&&r?`${e}_${r}`:`anon_${crypto.randomUUID()}`;await ec(xn(this.db,"responses",s),t)}async saveFamilyResponse(t){await ec(xn(this.db,"responses",t.familyKey),{familyName:t.familyName,people:t.people})}async getFamilyResponse(t){const e=xn(this.db,"responses",t),r=await pp(e);if(!r.exists())return null;const s=r.data();return{familyKey:t,familyName:s.familyName||"",people:s.people||[]}}async getAllFamilies(){const t=Ms(Tr(this.db,"responses"));return(await gp(t)).docs.map(r=>({key:r.id,name:r.data().familyName||r.id}))}async addFaq(t){await yp(Tr(this.db,"faqs"),{...t,author:t.author.toUpperCase(),createdAt:Ep(),answers:[]})}onFaqs(t){const e=Ms(Tr(this.db,"faqs"),Ja("createdAt","desc"));return nc(e,r=>{const s=r.docs.map(o=>({id:o.id,data:o.data()}));t(s)})}onFaqReplies(t,e){const r=Ms(Tr(this.db,"faqs",t,"replies"),Ja("createdAt","asc"));return nc(r,s=>{const o=s.docs.map(a=>({id:a.id,data:a.data()}));e(o)})}async addFaqAnswer(t,e){const r=xn(this.db,"faqs",t);await _p(r,{answers:vp({author:e.author.toUpperCase(),text:e.text})})}}const wr=new Map;function Ip(n){const t=document.getElementById("faq-form"),e=document.getElementById("faq-status"),r=document.getElementById("faq-list");if(!r)return;const s=(l,h=!1)=>{e&&(e.textContent=l,e.classList.remove("ok","err"),e.classList.add(h?"ok":"err"))},o=l=>{r.innerHTML="";for(const{id:h,data:d}of l){const m=document.createElement("div");m.className="faq-card";const E=(d.author??"").toString().trim()||"ANONYMOUS",w=Array.isArray(d.answers)?d.answers:[],b=w.length,V=b<=2,N=wr.has(h)?!!wr.get(h):V;m.innerHTML=`
    ...
    `,W.querySelector(".remove-person-btn")?.addEventListener("click",()=>{const it=$t(W),ie=()=>{const zt=s.querySelectorAll(".person-form").length===1;W.remove(),ut(),zt?$e():qe()};if(it){T();const Bt=()=>{p(),ie(),w.removeEventListener("click",Bt)};w.addEventListener("click",Bt)}else ie()});const Z=W.querySelector(".dietary-toggle"),G=W.querySelector(`#dietary-${L}`);Z?.addEventListener("change",()=>{if(Z.checked)G?.classList.remove("hidden");else{G?.classList.add("hidden"),G?.querySelectorAll(`input[name="person-${L}-dietary"]`)?.forEach(zt=>{zt.checked=!1});const ie=G?.querySelector(`textarea[name="person-${L}-dietary-notes"]`);ie&&(ie.value=""),W.querySelector(`#dietary-notes-${L}`)?.classList.add("hidden")}});const kt=W.querySelector('input[value="other"]'),vt=W.querySelector(`#dietary-notes-${L}`);kt?.addEventListener("change",()=>{kt.checked?vt?.classList.remove("hidden"):vt?.classList.add("hidden")}),W.querySelectorAll(`input[name="person-${L}-lodge"]`).forEach(it=>{it.addEventListener("change",ut)});const It=W.querySelector(`input[name="person-${L}-lodge"][value="friday"]`),Ot=W.querySelector(`input[name="person-${L}-meal"][value="friday-dinner"]`);if(It&&Ot){let it=!1;It.addEventListener("change",()=>{It.checked?Ot.checked||(Ot.checked=!0,it=!0,ut()):it&&(Ot.checked=!1,it=!1,ut())}),Ot.addEventListener("change",()=>{It.checked&&(it=!1)}),It.checked&&!Ot.checked&&(Ot.checked=!0,it=!0)}W.querySelectorAll(`input[name="person-${L}-meal"]`).forEach(it=>{it.addEventListener("change",ut)}),W.querySelectorAll('input[type="text"], input[type="email"], input[type="tel"], input[type="checkbox"], textarea').forEach(it=>{it.addEventListener("input",qe),it.addEventListener("change",qe)}),s.appendChild(W),ut(),qe()},je=()=>{s.innerHTML="",j=0,$e(),ut()};r.addEventListener("click",()=>{$e()}),$e();const Se=()=>{const q=new FormData(t),L=[];return s.querySelectorAll(".person-form").forEach($=>{const Z=$.getAttribute("data-person-idx");if(!Z)return;const G=String(q.get(`person-${Z}-firstName`)??"").trim(),kt=String(q.get(`person-${Z}-lastName`)??"").trim(),vt=String(q.get(`person-${Z}-email`)??"").trim(),jt=String(q.get(`person-${Z}-phone`)??"").trim(),It=[];$.querySelectorAll(`input[name="person-${Z}-lodge"]:checked`).forEach(dt=>{It.push(dt.value)});const se=[];se.push("saturday-dinner"),$.querySelectorAll(`input[name="person-${Z}-meal"]:checked:not([disabled])`).forEach(dt=>{se.push(dt.value)});const it=[];$.querySelectorAll(`input[name="person-${Z}-dietary"]:checked`).forEach(dt=>{it.push(dt.value)});const Bt=it.includes("other")?String(q.get(`person-${Z}-dietary-notes`)??"").trim():"",zt=String(q.get(`person-${Z}-notes`)??"").trim(),rr=It.length>0,ot={firstName:G,lastName:kt,email:vt,phone:jt,coming:!0,overnight:rr};It.length>0&&(ot.rainbowLodgeNights=It),se.length>0&&(ot.meals=se),it.length>0&&(ot.dietaryRestrictions=it),Bt&&(ot.dietaryNotes=Bt),zt&&(ot.notes=zt),L.push(ot)}),L},us=q=>{const L={"friday-dinner":"Friday rehearsal dinner","saturday-breakfast":"Saturday breakfast","saturday-lunch":"Saturday lunch","saturday-dinner":"Saturday wedding dinner","sunday-brunch":"Sunday brunch"},W={vegetarian:"Vegetarian",vegan:"Vegan",pescatarian:"Pescatarian","dairy-free":"Dairy-free","nut-free":"Nut-free","egg-free":"Egg-free","gluten-free":"Gluten-free",other:"Other"};let $="";q.forEach(G=>{if($+='<div class="preview-person">',$+=`<h3>${G.firstName} ${G.lastName}</h3>`,G.email&&($+=`<p><strong>Email:</strong> ${G.email}</p>`),G.phone&&($+=`<p><strong>Phone:</strong> ${G.phone}</p>`),G.rainbowLodgeNights&&G.rainbowLodgeNights.length>0){const vt=G.rainbowLodgeNights.map(jt=>jt.charAt(0).toUpperCase()+jt.slice(1)).join(", ");$+=`<p><strong>Staying at Rainbow Lodge:</strong> ${vt}</p>`}else $+="<p><strong>Staying at Rainbow Lodge:</strong> N/A</p>";const kt=G.meals?.filter(vt=>vt!=="saturday-dinner")||[];if(G.meals&&G.meals.length>0&&kt.length>0){const vt=["friday-dinner","saturday-breakfast","saturday-lunch","saturday-dinner","sunday-brunch"],jt=G.meals.sort((It,Ot)=>vt.indexOf(It)-vt.indexOf(Ot));$+='<p><strong>Meals:</strong></p><ul style="margin: 0.25rem 0 0 1.5rem;">',jt.forEach(It=>{$+=`<li>${L[It]||It}</li>`}),$+="</ul>"}else $+="<p><strong>Meals:</strong> Saturday wedding dinner only</p>";G.dietaryRestrictions&&G.dietaryRestrictions.length>0?($+='<p><strong>Dietary Restrictions:</strong></p><ul style="margin: 0.25rem 0 0 1.5rem;">',G.dietaryRestrictions.forEach(vt=>{$+=`<li>${W[vt]||vt}</li>`}),$+="</ul>",G.dietaryNotes&&($+=`<p style="margin-left: 1.5rem;"><em>${G.dietaryNotes}</em></p>`)):$+="<p><strong>Dietary Restrictions:</strong> N/A</p>",G.notes&&($+=`<p><strong>Notes:</strong> ${G.notes}</p>`),$+="</div>"});const Z=g();return $+=`<div class="preview-total">Total Cost: $${Z}</div>`,$};t.addEventListener("submit",async q=>{if(q.preventDefault(),!!e)try{const L=Se();if(!L.some(Z=>Z.email&&Z.phone)){H("At least one person needs to provide email and phone");return}const $=us(L);V.innerHTML=$,_()}catch(L){console.error(L),H("Oops—couldn't process your response. Please try again.")}}),P.addEventListener("click",async()=>{if(e){e.disabled=!0,P.disabled=!0;try{const q=Se(),L=Date.now(),$=`${q[0]?.lastName?.toLowerCase().replace(/\s+/g,"_")||"guest"}_${L}`,Z=q.map(kt=>`${kt.firstName} ${kt.lastName}`).join(", "),G={familyKey:$,familyName:Z,people:q};await n.saveFamilyResponse(G),v(),_t(),setTimeout(()=>{ct(),je(),e.disabled=!1,P.disabled=!1},3e3)}catch(q){console.error(q),v(),H("Oops—couldn't save your response. Please try again."),e.disabled=!1,P.disabled=!1}}})}const rc={"/404":"/pages/404.html","/rsvp":"/pages/rsvp.html"},sc=new wp,ic=n=>{Pp(),Dp(),Sp(n),Cp(n),Rp(sc),Ip(sc)};window.addEventListener("DOMContentLoaded",()=>{const n=document.querySelector("#app"),t=navigator.userAgent.toLowerCase(),e=/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini|mobile|tablet/i.test(t),r=window.innerWidth<768||window.innerHeight<600,s="ontouchstart"in window||navigator.maxTouchPoints>0,o=e||r&&s,a=new bp({onRoute:async l=>{if(o&&(l==="/"||l===""||l==="/rsvp")){n.innerHTML=`
