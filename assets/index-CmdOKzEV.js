 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr=new Map,qh=new Map,Us=new Map;function Xo(n,t){try{n.container.addComponent(t)}catch(e){ee.debug(`Component ${t.name} failed to register with FirebaseApp ${n.name}`,e)}}function Nr(n){const t=n.name;if(Us.has(t))return ee.debug(`There were multiple attempts to register component ${t}.`),!1;Us.set(t,n);for(const e of Dr.values())Xo(e,n);for(const e of qh.values())Xo(e,n);return!0}function Uh(n,t){const e=n.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),n.container.getProvider(t)}function $h(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aa=-62135596800,ca=1e6;class ot{static now(){return ot.fromMillis(Date.now())}static fromDate(t){return ot.fromMillis(t.getTime())}static fromMillis(t){const e=Math.floor(t/1e3),r=Math.floor((t-1e3*e)*ca);return new ot(e,r)}constructor(t,e){if(this.seconds=t,this.nanoseconds=e,e<0)throw new N(S.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+e);if(e>=1e9)throw new N(S.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+e);if(t<aa)throw new N(S.INVALID_ARGUMENT,"Timestamp seconds out of range: "+t);if(t>=253402300800)throw new N(S.INVALID_ARGUMENT,"Timestamp seconds out of range: "+t)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/ca}_compareTo(t){return this.seconds===t.seconds?K(this.nanoseconds,t.nanoseconds):K(this.seconds,t.seconds)}isEqual(t){return t.seconds===this.seconds&&t.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:ot._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(t){if(Yn(t,ot._jsonSchema))return new ot(t.seconds,t.nanoseconds)}valueOf(){const t=this.seconds-aa;return String(t).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}ot._jsonSchemaVersion="firestore/timestamp/1.0",ot._jsonSchema={type:yt("string",ot._jsonSchemaVersion),seconds:yt("number"),nanoseconds:yt("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{constructor(t){this.fields=t,t.sort(bt.comparator)}static empty(){return new Lt([])}unionWith(t){let e=new vt(bt.comparator);for(const r of this.fields)e=e.add(r);for(const r of t)e=e.add(r);return new Lt(e.toArray())}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return tn(this.fields,t.fields,((e,r)=>e.isEqual(r)))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pc="server_timestamp",Vc="__type__",Dc="__previous_value__",Nc="__local_write_time__";function di(n){return(n?.mapValue?.fields||{})[Vc]?.stringValue===Pc}function Kr(n){const t=n.mapValue.fields[Dc];return di(t)?Kr(t):t}function Hn(n){const t=ye(n.mapValue.fields[Nc].timestampValue);return new ot(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vi{constructor(){this.Qr=new vt(wt.$r),this.Ur=new vt(wt.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(t,e){const r=new wt(t,e);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(t,e){t.forEach((r=>this.addReference(r,e)))}removeReference(t,e){this.Gr(new wt(t,e))}zr(t,e){t.forEach((r=>this.removeReference(r,e)))}jr(t){const e=new M(new rt([])),r=new wt(e,t),s=new wt(e,t+1),o=[];return this.Ur.forEachInRange([r,s],(a=>{this.Gr(a),o.push(a.key)})),o}Jr(){this.Qr.forEach((t=>this.Gr(t)))}Gr(t){this.Qr=this.Qr.delete(t),this.Ur=this.Ur.delete(t)}Hr(t){const e=new M(new rt([])),r=new wt(e,t),s=new wt(e,t+1);let o=Q();return this.Ur.forEachInRange([r,s],(a=>{o=o.add(a.key)})),o}containsKey(t){const e=new wt(t,0),r=this.Qr.firstAfterOrEqual(e);return r!==null&&t.isEqual(r.key)}}class wt{constructor(t,e){this.key=t,this.Yr=e}static $r(t,e){return M.comparator(t.key,e.key)||K(t.Yr,e.Yr)}static Kr(t,e){return K(t.Yr,e.Yr)||M.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const St="WebChannelConnection";class lm extends cm{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,r,s,o){const a=ei();return new Promise(((l,h)=>{const d=new _c;d.setWithCredentials(!0),d.listenOnce(yc.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Ar.NO_ERROR:const y=d.getResponseJson();x(St,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(y)),l(y);break;case Ar.TIMEOUT:x(St,`RPC '${t}' ${a} timed out`),h(new N(S.DEADLINE_EXCEEDED,"Request time out"));break;case Ar.HTTP_ERROR:const w=d.getStatus();if(x(St,`RPC '${t}' ${a} failed with status:`,w,"response text:",d.getResponseText()),w>0){let b=d.getResponseJson();Array.isArray(b)&&(b=b[0]);const V=b?.error;if(V&&V.status&&V.message){const k=(function(q){const j=q.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(j)>=0?j:S.UNKNOWN})(V.status);h(new N(k,V.message))}else h(new N(S.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new N(S.UNAVAILABLE,"Connection failed."));break;default:O(9055,{l_:t,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{x(St,`RPC '${t}' ${a} completed.`)}}));const m=JSON.stringify(s);x(St,`RPC '${t}' ${a} sending request:`,s),d.send(e,"POST",m,r,15)}))}T_(t,e,r){const s=ei(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=Tc(),l=vc(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.jo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");x(St,`Creating RPC '${t}' stream ${s}: ${m}`,h);const y=a.createWebChannel(m,h);this.I_(y);let w=!1,b=!1;const V=new um({Yo:P=>{b?x(St,`Not sending because RPC '${t}' stream ${s} is closed:`,P):(w||(x(St,`Opening RPC '${t}' stream ${s} transport.`),y.open(),w=!0),x(St,`RPC '${t}' stream ${s} sending:`,P),y.send(P))},Zo:()=>y.close()}),k=(P,q,j)=>{P.listen(q,(H=>{try{j(H)}catch(at){setTimeout((()=>{throw at}),0)}}))};return k(y,Dn.EventType.OPEN,(()=>{b||(x(St,`RPC '${t}' stream ${s} transport opened.`),V.o_())})),k(y,Dn.EventType.CLOSE,(()=>{b||(b=!0,x(St,`RPC '${t}' stream ${s} transport closed`),V.a_(),this.E_(y))})),k(y,Dn.EventType.ERROR,(P=>{b||(b=!0,Ze(St,`RPC '${t}' stream ${s} transport errored. Name:`,P.name,"Message:",P.message),V.a_(new N(S.UNAVAILABLE,"The operation could not be completed")))})),k(y,Dn.EventType.MESSAGE,(P=>{if(!b){const q=P.data[0];Z(!!q,16349);const j=q,H=j?.error||j[0]?.error;if(H){x(St,`RPC '${t}' stream ${s} received error:`,H);const at=H.status;let tt=(function(g){const _=gt[g];if(_!==void 0)return ru(_)})(at),ct=H.message;tt===void 0&&(tt=S.INTERNAL,ct="Unknown error status: "+at+" with message "+H.message),b=!0,V.a_(new N(tt,ct)),y.close()}else x(St,`RPC '${t}' stream ${s} received:`,q),V.u_(q)}})),k(l,Ec.STAT_EVENT,(P=>{P.stat===$s.PROXY?x(St,`RPC '${t}' stream ${s} detected buffering proxy`):P.stat===$s.NOPROXY&&x(St,`RPC '${t}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{V.__()}),0),V}terminate(){this.c_.forEach((t=>t.close())),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter((e=>e===t))}}function xs(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Re{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new Re(this.firestore,t,this._query)}}class dt{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new ge(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new dt(this.firestore,t,this._key)}toJSON(){return{type:dt._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,e,r){if(Yn(e,dt._jsonSchema))return new dt(t,r||null,new M(rt.fromString(e.referencePath)))}}dt._jsonSchemaVersion="firestore/documentReference/1.0",dt._jsonSchema={type:yt("string",dt._jsonSchemaVersion),referencePath:yt("string")};class ge extends Re{constructor(t,e,r){super(t,e,Qr(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new dt(this.firestore,null,new M(t))}withConverter(t){return new ge(this.firestore,t,this._path)}}function Tr(n,t,...e){if(n=Jt(n),Ac("collection","path",t),n instanceof rs){const r=rt.fromString(t,...e);return oa(r),new ge(n,null,r)}{if(!(n instanceof dt||n instanceof ge))throw new N(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(rt.fromString(t,...e));return oa(r),new ge(n.firestore,null,r)}}function xn(n,t,...e){if(n=Jt(n),arguments.length===1&&(t=li.newId()),Ac("doc","path",t),n instanceof rs){const r=rt.fromString(t,...e);return ia(r),new dt(n,null,new M(r))}{if(!(n instanceof dt||n instanceof ge))throw new N(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(rt.fromString(t,...e));return ia(r),new dt(n.firestore,n instanceof ge?n.converter:null,new M(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xt{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new N(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new N(S.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return K(this._lat,t._lat)||K(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Xt._jsonSchemaVersion}}static fromJSON(t){if(Yn(t,Xt._jsonSchema))return new Xt(t.latitude,t.longitude)}}Xt._jsonSchemaVersion="firestore/geoPoint/1.0",Xt._jsonSchema={type:yt("string",Xt._jsonSchemaVersion),latitude:yt("number"),longitude:yt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function pp(n){n=Mt(n,dt);const t=Mt(n.firestore,Ie);return Zm(ss(t),n._key).then((e=>Ku(t,n,e)))}Me._jsonSchemaVersion="firestore/querySnapshot/1.0",Me._jsonSchema={type:yt("string",Me._jsonSchemaVersion),bundleSource:yt("string","QuerySnapshot"),bundleName:yt("string"),bundle:yt("string")};class Gi extends fp{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ft(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new dt(this.firestore,null,e)}}function gp(n){n=Mt(n,Re);const t=Mt(n.firestore,Ie),e=ss(t),r=new Gi(t);return ju(n._query),tp(e,n._query).then((s=>new Me(t,r,n,s)))}function ec(n,t,e){n=Mt(n,dt);const r=Mt(n.firestore,Ie),s=Gu(n.converter,t);return Ki(r,[Fu(as(r),"setDoc",n._key,s,n.converter!==null,e).toMutation(n._key,qt.none())])}function _p(n,t,e,...r){n=Mt(n,dt);const s=Mt(n.firestore,Ie),o=as(s);let a;return a=typeof(t=Jt(t))=="string"||t instanceof is?up(o,"updateDoc",n._key,t,e,r):cp(o,"updateDoc",n._key,t),Ki(s,[a.toMutation(n._key,qt.exists(!0))])}function yp(n,t){const e=Mt(n.firestore,Ie),r=xn(n),s=Gu(n.converter,t);return Ki(e,[Fu(as(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,qt.exists(!1))]).then((()=>r))}function nc(n,...t){n=Jt(n);let e={includeMetadataChanges:!1,source:"default"},r=0;typeof t[r]!="object"||Ya(t[r])||(e=t[r++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(Ya(t[r])){const h=t[r];t[r]=h.next?.bind(h),t[r+1]=h.error?.bind(h),t[r+2]=h.complete?.bind(h)}let o,a,l;if(n instanceof dt)a=Mt(n.firestore,Ie),l=Qr(n._key.path),o={next:h=>{t[r]&&t[r](Ku(a,n,h))},error:t[r+1],complete:t[r+2]};else{const h=Mt(n,Re);a=Mt(h.firestore,Ie),l=h._query;const d=new Gi(a);o={next:m=>{t[r]&&t[r](new Me(a,d,h,m))},error:t[r+1],complete:t[r+2]},ju(n._query)}return(function(d,m,y,w){const b=new Mi(w),V=new ki(m,b,y);return d.asyncQueue.enqueueAndForget((async()=>Vi(await $r(d),V))),()=>{b.Nu(),d.asyncQueue.enqueueAndForget((async()=>Di(await $r(d),V)))}})(ss(a),l,s,o)}function Ki(n,t){return(function(r,s){const o=new te;return r.asyncQueue.enqueueAndForget((async()=>Um(await Jm(r),s,o))),o.promise})(ss(n),t)}function Ku(n,t,e){const r=e.docs.get(t._key),s=new Gi(n);return new Le(n,s,t._key,r,new Ln(e.hasPendingWrites,e.fromCache),t.converter)}function Ep(){return new Oi("serverTimestamp")}function vp(...n){return new Fi("arrayUnion",n)}(function(t,e=!0){(function(s){cn=s})(Hh),Nr(new $n("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),l=new Ie(new ad(r.getProvider("auth-internal")),new ld(a,r.getProvider("app-check-internal")),(function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new N(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Gn(d.options.projectId,m)})(a,s),a);return o={useFetchStreams:e,...o},l._setSettings(o),l}),"PUBLIC").setMultipleInstances(!0)),Ye(ea,na,t),Ye(ea,na,"esm2020")})();const Tp={apiKey:"AIzaSyC_JekFZUQ5xpp33viYesstWMWW1IWrjPs",authDomain:"wedding-d16cc.firebaseapp.com",projectId:"wedding-d16cc",storageBucket:"wedding-d16cc.firebasestorage.app",messagingSenderId:"398999128995",appId:"1:398999128995:web:8f76adc5172ba04dbe6816",measurementId:"G-7BZV4Q5649"};class wp{db;constructor(){const t=fc(Tp);this.db=np(t)}async addRsvp(t){const e=(t.firstName||"").trim().toLowerCase().replace(/\s+/g,"_"),r=(t.lastName||"").trim().toLowerCase().replace(/\s+/g,"_"),s=e&&r?`${e}_${r}`:`anon_${crypto.randomUUID()}`;await ec(xn(this.db,"responses",s),t)}async saveFamilyResponse(t){await ec(xn(this.db,"responses",t.familyKey),{familyName:t.familyName,people:t.people})}async getFamilyResponse(t){const e=xn(this.db,"responses",t),r=await pp(e);if(!r.exists())return null;const s=r.data();return{familyKey:t,familyName:s.familyName||"",people:s.people||[]}}async getAllFamilies(){const t=Ms(Tr(this.db,"responses"));return(await gp(t)).docs.map(r=>({key:r.id,name:r.data().familyName||r.id}))}async addFaq(t){await yp(Tr(this.db,"faqs"),{...t,author:t.author.toUpperCase(),createdAt:Ep(),answers:[]})}onFaqs(t){const e=Ms(Tr(this.db,"faqs"),Ja("createdAt","desc"));return nc(e,r=>{const s=r.docs.map(o=>({id:o.id,data:o.data()}));t(s)})}onFaqReplies(t,e){const r=Ms(Tr(this.db,"faqs",t,"replies"),Ja("createdAt","asc"));return nc(r,s=>{const o=s.docs.map(a=>({id:a.id,data:a.data()}));e(o)})}async addFaqAnswer(t,e){const r=xn(this.db,"faqs",t);await _p(r,{answers:vp({author:e.author.toUpperCase(),text:e.text})})}}const wr=new Map;function Ip(n){const t=document.getElementById("faq-form"),e=document.getElementById("faq-status"),r=document.getElementById("faq-list");if(!r)return;const s=document.querySelector(".faq-scroll");s&&s.addEventListener("wheel",h=>{const d=s.scrollTop===0,m=h.deltaY<0;d&&m||h.stopPropagation()},{passive:!0});const o=(h,d=!1)=>{e&&(e.textContent=h,e.classList.remove("ok","err"),e.classList.add(d?"ok":"err"))},a=h=>{r.innerHTML="";for(const{id:d,data:m}of h){const y=document.createElement("div");y.className="faq-card";const w=(m.author??"").toString().trim()||"ANONYMOUS",b=Array.isArray(m.answers)?m.answers:[],V=b.length,k=V<=2,P=wr.has(d)?!!wr.get(d):k;y.innerHTML=`
      ...
      `;const q=y.querySelector(".faq-answers"),j=y.querySelector(".answers-header"),H=y.querySelector(".caret");q&&j&&H&&j.addEventListener("click",()=>{const p=!q.classList.toggle("collapsed");wr.set(d,p),j.setAttribute("aria-expanded",String(p)),H.classList.toggle("open",p)});const at=y.querySelector(".reply-toggle"),tt=y.querySelector(".faq-reply-form"),ct=tt.querySelector(".reply-submit"),v=tt.querySelector(".reply-cancel"),g=tt.querySelector(".faq-reply-author"),_=tt.querySelector(".faq-reply-text"),T=()=>{tt.classList.remove("hidden"),at.style.display="none",g.focus();const I=p=>{p.key==="Escape"&&(p.stopPropagation(),E(!1))};tt.addEventListener("keydown",I),tt._escHandler=I},E=I=>{const p=tt._escHandler;p&&tt.removeEventListener("keydown",p),I&&tt.reset(),tt.classList.add("hidden"),at.style.display="",at.focus()};at.addEventListener("click",T),v.addEventListener("click",()=>E(!0)),tt.addEventListener("submit",async I=>{I.preventDefault(),ct.disabled=!0;try{const p=g.value.trim(),st=_.value.trim();if(!p||!st)return;q&&(q.classList.remove("collapsed"),j?.setAttribute("aria-expanded","true"),H?.classList.add("open")),wr.set(d,!0),await n.addFaqAnswer(d,{author:p,text:st}),E(!0)}catch(p){console.error(p)}finally{ct.disabled=!1}}),r.appendChild(y)}},l=n.onFaqs(a);if(t){let h=!1;t.addEventListener("submit",async d=>{if(d.preventDefault(),!h){h=!0;try{const m=new FormData(t),y=String(m.get("author")||"").trim(),w=String(m.get("question")||"").trim(),b=Number(sessionStorage.getItem("faq:lastPostTs")||"0"),V=Date.now();if(V-b<5e3){o("You're too fast—give it a sec 🐸",!1);return}if(!w){o("Ask a real question first :)",!1);return}await Ap(n,y,w),sessionStorage.setItem("faq:lastPostTs",String(V)),t.reset(),o("Posted!",!0)}catch(m){console.error(m),o("Couldn't post—try again?",!1)}finally{h=!1}}})}window.addEventListener("beforeunload",()=>l(),{once:!0})}async function Ap(n,t,e){await n.addFaq({author:t,question:e,answers:[]})}function Ir(n){return n.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}class bp{onRoute;constructor(t){this.onRoute=t.onRoute,window.addEventListener("popstate",()=>this.handlePop())}navigate(t){const e=this.getPath();history.pushState({previous:e},"",t),this.onRoute(this.getPath())}handlePop(){this.onRoute(this.getPath())}getPath(){return window.location.pathname}start(){this.onRoute(this.getPath())}}function Rp(n){const t=document.getElementById("rsvp-form"),e=document.getElementById("rsvp-submit"),r=document.getElementById("add-person-btn"),s=document.getElementById("people-forms-container"),o=document.querySelector(".rsvp-note"),a=document.getElementById("rsvp-cost"),l=document.getElementById("error-modal"),h=document.getElementById("error-message"),d=document.getElementById("close-error-modal"),m=document.getElementById("confirm-modal"),y=document.getElementById("confirm-cancel"),w=document.getElementById("confirm-delete"),b=document.getElementById("preview-modal"),V=document.getElementById("preview-content"),k=document.getElementById("preview-cancel"),P=document.getElementById("preview-confirm"),q=document.getElementById("success-overlay");if(!t||!s||!r||!o||!l||!h||!d||!m||!y||!w||!b||!V||!k||!P||!q)return;let j=0;const H=U=>{h.textContent=U,l.classList.remove("hidden")},at=()=>{l.classList.add("hidden")},tt=()=>{q.classList.remove("hidden")},ct=()=>{q.classList.add("hidden")},v=()=>{m.classList.remove("hidden")},g=()=>{m.classList.add("hidden")},_=()=>{b.classList.remove("hidden")},T=()=>{b.classList.add("hidden")};d.addEventListener("click",at),l.addEventListener("click",U=>{U.target===l&&at()}),y.addEventListener("click",g),m.addEventListener("click",U=>{U.target===m&&g()}),k.addEventListener("click",T),b.addEventListener("click",U=>{U.target===b&&T()}),document.addEventListener("keydown",U=>{U.key==="Escape"&&(l.classList.contains("hidden")?m.classList.contains("hidden")?b.classList.contains("hidden")||T():g():at())});const E={"friday-dinner":0,"saturday-breakfast":50,"saturday-lunch":50,"saturday-dinner":0,"sunday-brunch":0},I=100,p=()=>{let U=0;for(let L=0;L<j;L++){const W=document.querySelector(`[data-person-idx="${L}"]`);if(!W)continue;const $=W.querySelectorAll(`input[name="person-${L}-lodge"]:checked`);U+=$.length*I,W.querySelectorAll(`input[name="person-${L}-meal"]:checked`).forEach(G=>{U+=E[G.value]||0})}return U},st=()=>{if(!a)return;const U=p();a.textContent=`Total: $${U}`},$t=U=>{const L=U.querySelectorAll('input[type="text"], input[type="email"], input[type="tel"]');for(const J of L)if(J.value.trim())return!0;const W=U.querySelectorAll('input[type="checkbox"]:not([disabled])');for(const J of W)if(J.checked)return!0;return!!U.querySelector("textarea")?.value.trim()},Ue=()=>{const U=s.querySelectorAll(".person-form"),L=U.length===1;U.forEach(W=>{const $=W.querySelector(".remove-person-btn");if(!$)return;const J=$t(W);L&&!J?($.disabled=!0,$.classList.add("disabled")):($.disabled=!1,$.classList.remove("disabled"))})},$e=U=>{const L=j++,W=document.createElement("div");W.className="person-form",W.setAttribute("data-person-idx",String(L)),W.innerHTML=`
    ...
    `,W.querySelector(".remove-person-btn")?.addEventListener("click",()=>{const et=$t(W),ie=()=>{const zt=s.querySelectorAll(".person-form").length===1;W.remove(),st(),zt?$e():Ue()};if(et){v();const Bt=()=>{g(),ie(),w.removeEventListener("click",Bt)};w.addEventListener("click",Bt)}else ie()});const J=W.querySelector(".dietary-toggle"),G=W.querySelector(`#dietary-${L}`);J?.addEventListener("change",()=>{if(J.checked)G?.classList.remove("hidden");else{G?.classList.add("hidden"),G?.querySelectorAll(`input[name="person-${L}-dietary"]`)?.forEach(zt=>{zt.checked=!1});const ie=G?.querySelector(`textarea[name="person-${L}-dietary-notes"]`);ie&&(ie.value=""),W.querySelector(`#dietary-notes-${L}`)?.classList.add("hidden")}});const kt=W.querySelector('input[value="other"]'),pt=W.querySelector(`#dietary-notes-${L}`);kt?.addEventListener("change",()=>{const et=pt?.querySelector("textarea");kt.checked?(pt?.classList.remove("hidden"),et&&(et.required=!0)):(pt?.classList.add("hidden"),et&&(et.required=!1))}),W.querySelectorAll(`input[name="person-${L}-lodge"]`).forEach(et=>{et.addEventListener("change",st)});const It=W.querySelector(`input[name="person-${L}-lodge"][value="friday"]`),Ot=W.querySelector(`input[name="person-${L}-meal"][value="friday-dinner"]`);if(It&&Ot){let et=!1;It.addEventListener("change",()=>{It.checked?Ot.checked||(Ot.checked=!0,et=!0,st()):et&&(Ot.checked=!1,et=!1,st())}),Ot.addEventListener("change",()=>{It.checked&&(et=!1)}),It.checked&&!Ot.checked&&(Ot.checked=!0,et=!0)}W.querySelectorAll(`input[name="person-${L}-meal"]`).forEach(et=>{et.addEventListener("change",st)}),W.querySelectorAll('input[type="text"], input[type="email"], input[type="tel"], input[type="checkbox"], textarea').forEach(et=>{et.addEventListener("input",Ue),et.addEventListener("change",Ue)}),s.appendChild(W),st(),Ue()},je=()=>{s.innerHTML="",j=0,$e(),st()};r.addEventListener("click",()=>{$e()}),$e();const Se=()=>{const U=new FormData(t),L=[];return s.querySelectorAll(".person-form").forEach($=>{const J=$.getAttribute("data-person-idx");if(!J)return;const G=String(U.get(`person-${J}-firstName`)??"").trim(),kt=String(U.get(`person-${J}-lastName`)??"").trim(),pt=String(U.get(`person-${J}-email`)??"").trim(),jt=String(U.get(`person-${J}-phone`)??"").trim(),It=[];$.querySelectorAll(`input[name="person-${J}-lodge"]:checked`).forEach(ft=>{It.push(ft.value)});const se=[];se.push("saturday-dinner"),$.querySelectorAll(`input[name="person-${J}-meal"]:checked:not([disabled])`).forEach(ft=>{se.push(ft.value)});const et=[];$.querySelectorAll(`input[name="person-${J}-dietary"]:checked`).forEach(ft=>{et.push(ft.value)});const Bt=et.includes("other")?String(U.get(`person-${J}-dietary-notes`)??"").trim():"",zt=String(U.get(`person-${J}-notes`)??"").trim(),rr=It.length>0,ut={firstName:G,lastName:kt,email:pt,phone:jt,coming:!0,overnight:rr};It.length>0&&(ut.rainbowLodgeNights=It),se.length>0&&(ut.meals=se),et.length>0&&(ut.dietaryRestrictions=et),Bt&&(ut.dietaryNotes=Bt),zt&&(ut.notes=zt),L.push(ut)}),L},us=U=>{const L={"friday-dinner":"Friday rehearsal dinner","saturday-breakfast":"Saturday breakfast","saturday-lunch":"Saturday lunch","saturday-dinner":"Saturday wedding dinner","sunday-brunch":"Sunday brunch"},W={vegetarian:"Vegetarian",vegan:"Vegan",pescatarian:"Pescatarian","dairy-free":"Dairy-free","nut-free":"Nut-free","egg-free":"Egg-free","gluten-free":"Gluten-free",other:"Other"};let $="";U.forEach(G=>{if($+='<div class="preview-person">',$+=`<h3>${G.firstName} ${G.lastName}</h3>`,G.email&&($+=`<p><strong>Email:</strong> ${G.email}</p>`),G.phone&&($+=`<p><strong>Phone:</strong> ${G.phone}</p>`),G.rainbowLodgeNights&&G.rainbowLodgeNights.length>0){const pt=G.rainbowLodgeNights.map(jt=>jt.charAt(0).toUpperCase()+jt.slice(1)).join(", ");$+=`<p><strong>Staying at Rainbow Lodge:</strong> ${pt}</p>`}else $+="<p><strong>Staying at Rainbow Lodge:</strong> N/A</p>";const kt=G.meals?.filter(pt=>pt!=="saturday-dinner")||[];if(G.meals&&G.meals.length>0&&kt.length>0){const pt=["friday-dinner","saturday-breakfast","saturday-lunch","saturday-dinner","sunday-brunch"],jt=G.meals.sort((It,Ot)=>pt.indexOf(It)-pt.indexOf(Ot));$+='<p><strong>Meals:</strong></p><ul style="margin: 0.25rem 0 0 1.5rem;">',jt.forEach(It=>{$+=`<li>${L[It]||It}</li>`}),$+="</ul>"}else $+="<p><strong>Meals:</strong> Saturday wedding dinner only</p>";G.dietaryRestrictions&&G.dietaryRestrictions.length>0?($+='<p><strong>Dietary Restrictions:</strong></p><ul style="margin: 0.25rem 0 0 1.5rem;">',G.dietaryRestrictions.forEach(pt=>{pt!=="other"&&($+=`<li>${W[pt]||pt}</li>`)}),G.dietaryNotes&&($+=`<li>${G.dietaryNotes}</li>`),$+="</ul>"):$+="<p><strong>Dietary Restrictions:</strong> N/A</p>",G.notes&&($+=`<p><strong>Notes:</strong> ${G.notes}</p>`),$+="</div>"});const J=p();return $+=`<div class="preview-total">Total Cost: $${J}</div>`,$};t.addEventListener("submit",async U=>{if(U.preventDefault(),!!e)try{const L=Se();if(!L.some(J=>J.email&&J.phone)){H("At least one person needs to provide email and phone");return}const $=us(L);V.innerHTML=$,_()}catch(L){console.error(L),H("Oops—couldn't process your response. Please try again.")}}),P.addEventListener("click",async()=>{if(e){e.disabled=!0,P.disabled=!0;try{const U=Se(),L=Date.now(),$=`${U[0]?.lastName?.toLowerCase().replace(/\s+/g,"_")||"guest"}_${L}`,J=U.map(kt=>`${kt.firstName} ${kt.lastName}`).join(", "),G={familyKey:$,familyName:J,people:U};await n.saveFamilyResponse(G),T(),tt(),setTimeout(()=>{ct(),je(),e.disabled=!1,P.disabled=!1},3e3)}catch(U){console.error(U),T(),H("Oops—couldn't save your response. Please try again."),e.disabled=!1,P.disabled=!1}}})}const rc={"/404":"/pages/404.html","/rsvp":"/pages/rsvp.html"},sc=new wp,ic=n=>{Pp(),Dp(),Sp(n),Cp(n),Rp(sc),Ip(sc)};window.addEventListener("DOMContentLoaded",()=>{const n=document.querySelector("#app"),t=n.innerHTML,e=navigator.userAgent.toLowerCase(),r=/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini|mobile|tablet/i.test(e),s=window.innerWidth<768||window.innerHeight<600,o="ontouchstart"in window||navigator.maxTouchPoints>0,a=r||s&&o,l=new bp({onRoute:async h=>{if(a&&(h==="/"||h===""||h==="/rsvp")){n.innerHTML=`
