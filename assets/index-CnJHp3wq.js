 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(t,e,r,s,o){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(t,e,r){const s=new Map;return s.set(t,Zn.createSynthesizedTargetChangeForCurrentChange(t,e,r)),new ts(U.min(),s,new ut(W),se(),X())}}class Zn{constructor(t,e,r,s,o){this.resumeToken=t,this.current=e,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(t,e,r){return new Zn(r,e,X(),X(),X())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt="WebChannelConnection";class lm extends cm{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,r,s,o){const a=ei();return new Promise(((l,h)=>{const d=new _c;d.setWithCredentials(!0),d.listenOnce(yc.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case br.NO_ERROR:const y=d.getResponseJson();L(Rt,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(y)),l(y);break;case br.TIMEOUT:L(Rt,`RPC '${t}' ${a} timed out`),h(new N(S.DEADLINE_EXCEEDED,"Request time out"));break;case br.HTTP_ERROR:const w=d.getStatus();if(L(Rt,`RPC '${t}' ${a} failed with status:`,w,"response text:",d.getResponseText()),w>0){let b=d.getResponseJson();Array.isArray(b)&&(b=b[0]);const V=b?.error;if(V&&V.status&&V.message){const k=(function(z){const G=z.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(G)>=0?G:S.UNKNOWN})(V.status);h(new N(k,V.message))}else h(new N(S.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new N(S.UNAVAILABLE,"Connection failed."));break;default:O(9055,{l_:t,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{L(Rt,`RPC '${t}' ${a} completed.`)}}));const m=JSON.stringify(s);L(Rt,`RPC '${t}' ${a} sending request:`,s),d.send(e,"POST",m,r,15)}))}T_(t,e,r){const s=ei(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=Tc(),l=vc(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.jo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");L(Rt,`Creating RPC '${t}' stream ${s}: ${m}`,h);const y=a.createWebChannel(m,h);this.I_(y);let w=!1,b=!1;const V=new um({Yo:P=>{b?L(Rt,`Not sending because RPC '${t}' stream ${s} is closed:`,P):(w||(L(Rt,`Opening RPC '${t}' stream ${s} transport.`),y.open(),w=!0),L(Rt,`RPC '${t}' stream ${s} sending:`,P),y.send(P))},Zo:()=>y.close()}),k=(P,z,G)=>{P.listen(z,(Q=>{try{G(Q)}catch(ot){setTimeout((()=>{throw ot}),0)}}))};return k(y,Dn.EventType.OPEN,(()=>{b||(L(Rt,`RPC '${t}' stream ${s} transport opened.`),V.o_())})),k(y,Dn.EventType.CLOSE,(()=>{b||(b=!0,L(Rt,`RPC '${t}' stream ${s} transport closed`),V.a_(),this.E_(y))})),k(y,Dn.EventType.ERROR,(P=>{b||(b=!0,Ze(Rt,`RPC '${t}' stream ${s} transport errored. Name:`,P.name,"Message:",P.message),V.a_(new N(S.UNAVAILABLE,"The operation could not be completed")))})),k(y,Dn.EventType.MESSAGE,(P=>{if(!b){const z=P.data[0];Z(!!z,16349);const G=z,Q=G?.error||G[0]?.error;if(Q){L(Rt,`RPC '${t}' stream ${s} received error:`,Q);const ot=Q.status;let tt=(function(g){const _=mt[g];if(_!==void 0)return ru(_)})(ot),at=Q.message;tt===void 0&&(tt=S.INTERNAL,at="Unknown error status: "+ot+" with message "+Q.message),b=!0,V.a_(new N(tt,at)),y.close()}else L(Rt,`RPC '${t}' stream ${s} received:`,z),V.u_(z)}})),k(l,Ec.STAT_EVENT,(P=>{P.stat===$s.PROXY?L(Rt,`RPC '${t}' stream ${s} detected buffering proxy`):P.stat===$s.NOPROXY&&L(Rt,`RPC '${t}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{V.__()}),0),V}terminate(){this.c_.forEach((t=>t.close())),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter((e=>e===t))}}function xs(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function pp(n){n=Lt(n,dt);const t=Lt(n.firestore,Ie);return Zm(is(t),n._key).then((e=>Ku(t,n,e)))}Le._jsonSchemaVersion="firestore/querySnapshot/1.0",Le._jsonSchema={type:gt("string",Le._jsonSchemaVersion),bundleSource:gt("string","QuerySnapshot"),bundleName:gt("string"),bundle:gt("string")};class Gi extends fp{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ot(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new dt(this.firestore,null,e)}}function gp(n){n=Lt(n,Re);const t=Lt(n.firestore,Ie),e=is(t),r=new Gi(t);return ju(n._query),tp(e,n._query).then((s=>new Le(t,r,n,s)))}function ec(n,t,e){n=Lt(n,dt);const r=Lt(n.firestore,Ie),s=Gu(n.converter,t);return Ki(r,[Fu(cs(r),"setDoc",n._key,s,n.converter!==null,e).toMutation(n._key,Bt.none())])}function _p(n,t,e,...r){n=Lt(n,dt);const s=Lt(n.firestore,Ie),o=cs(s);let a;return a=typeof(t=Xt(t))=="string"||t instanceof os?up(o,"updateDoc",n._key,t,e,r):cp(o,"updateDoc",n._key,t),Ki(s,[a.toMutation(n._key,Bt.exists(!0))])}function yp(n,t){const e=Lt(n.firestore,Ie),r=xn(n),s=Gu(n.converter,t);return Ki(e,[Fu(cs(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,Bt.exists(!1))]).then((()=>r))}function nc(n,...t){n=Xt(n);let e={includeMetadataChanges:!1,source:"default"},r=0;typeof t[r]!="object"||Ya(t[r])||(e=t[r++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(Ya(t[r])){const h=t[r];t[r]=h.next?.bind(h),t[r+1]=h.error?.bind(h),t[r+2]=h.complete?.bind(h)}let o,a,l;if(n instanceof dt)a=Lt(n.firestore,Ie),l=Wr(n._key.path),o={next:h=>{t[r]&&t[r](Ku(a,n,h))},error:t[r+1],complete:t[r+2]};else{const h=Lt(n,Re);a=Lt(h.firestore,Ie),l=h._query;const d=new Gi(a);o={next:m=>{t[r]&&t[r](new Le(a,d,h,m))},error:t[r+1],complete:t[r+2]},ju(n._query)}return(function(d,m,y,w){const b=new Mi(w),V=new ki(m,b,y);return d.asyncQueue.enqueueAndForget((async()=>Vi(await jr(d),V))),()=>{b.Nu(),d.asyncQueue.enqueueAndForget((async()=>Di(await jr(d),V)))}})(is(a),l,s,o)}function Ki(n,t){return(function(r,s){const o=new ee;return r.asyncQueue.enqueueAndForget((async()=>Um(await Jm(r),s,o))),o.promise})(is(n),t)}function Ku(n,t,e){const r=e.docs.get(t._key),s=new Gi(n);return new xe(n,s,t._key,r,new Ln(e.hasPendingWrites,e.fromCache),t.converter)}function Ep(){return new Oi("serverTimestamp")}function vp(...n){return new Fi("arrayUnion",n)}(function(t,e=!0){(function(s){cn=s})(Hh),kr(new $n("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),l=new Ie(new ad(r.getProvider("auth-internal")),new ld(a,r.getProvider("app-check-internal")),(function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new N(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Gn(d.options.projectId,m)})(a,s),a);return o={useFetchStreams:e,...o},l._setSettings(o),l}),"PUBLIC").setMultipleInstances(!0)),Ye(ea,na,t),Ye(ea,na,"esm2020")})();const Tp={apiKey:"AIzaSyC_JekFZUQ5xpp33viYesstWMWW1IWrjPs",authDomain:"wedding-d16cc.firebaseapp.com",projectId:"wedding-d16cc",storageBucket:"wedding-d16cc.firebasestorage.app",messagingSenderId:"398999128995",appId:"1:398999128995:web:8f76adc5172ba04dbe6816",measurementId:"G-7BZV4Q5649"};class wp{db;constructor(){const t=fc(Tp);this.db=np(t)}async addRsvp(t){const e=(t.firstName||"").trim().toLowerCase().replace(/\s+/g,"_"),r=(t.lastName||"").trim().toLowerCase().replace(/\s+/g,"_"),s=e&&r?`${e}_${r}`:`anon_${crypto.randomUUID()}`;await ec(xn(this.db,"responses",s),t)}async saveFamilyResponse(t){await ec(xn(this.db,"responses",t.familyKey),{familyName:t.familyName,people:t.people})}async getFamilyResponse(t){const e=xn(this.db,"responses",t),r=await pp(e);if(!r.exists())return null;const s=r.data();return{familyKey:t,familyName:s.familyName||"",people:s.people||[]}}async getAllFamilies(){const t=Ms(wr(this.db,"responses"));return(await gp(t)).docs.map(r=>({key:r.id,name:r.data().familyName||r.id}))}async addFaq(t){await yp(wr(this.db,"faqs"),{...t,author:t.author.toUpperCase(),createdAt:Ep(),answers:[]})}onFaqs(t){const e=Ms(wr(this.db,"faqs"),Ja("createdAt","desc"));return nc(e,r=>{const s=r.docs.map(o=>({id:o.id,data:o.data()}));t(s)})}onFaqReplies(t,e){const r=Ms(wr(this.db,"faqs",t,"replies"),Ja("createdAt","asc"));return nc(r,s=>{const o=s.docs.map(a=>({id:a.id,data:a.data()}));e(o)})}async addFaqAnswer(t,e){const r=xn(this.db,"faqs",t);await _p(r,{answers:vp({author:e.author.toUpperCase(),text:e.text})})}}const Ir=new Map;function Ip(n){const t=document.getElementById("faq-form"),e=document.getElementById("faq-status"),r=document.getElementById("faq-list");if(!r)return;const s=document.querySelector(".faq-scroll");s&&s.addEventListener("wheel",h=>{const d=s.scrollTop===0,m=h.deltaY<0;d&&m||h.stopPropagation()},{passive:!0});const o=(h,d=!1)=>{e&&(e.textContent=h,e.classList.remove("ok","err"),e.classList.add(d?"ok":"err"))},a=h=>{r.innerHTML="",h.reverse();for(const{id:d,data:m}of h){const y=document.createElement("div");y.className="faq-card";const w=(m.author??"").toString().trim()||"ANONYMOUS",b=Array.isArray(m.answers)?m.answers:[],V=b.length,k=V<=3,P=Ir.has(d)?!!Ir.get(d):k;y.innerHTML=`
    ...
    `,$.querySelector(".remove-person-btn")?.addEventListener("click",()=>{const ct=Ut($),te=()=>{const ie=s.querySelectorAll(".person-form").length===1;$.remove(),rt(),ie?Jt():qe()};if(ct){v();const Ft=()=>{g(),te(),w.removeEventListener("click",Ft)};w.addEventListener("click",Ft)}else te()});const H=$.querySelector(".dietary-toggle"),q=$.querySelector(`#dietary-${x}`);H?.addEventListener("change",()=>{if(H.checked)q?.classList.remove("hidden");else{q?.classList.add("hidden"),q?.querySelectorAll(`input[name="person-${x}-dietary"]`)?.forEach(ie=>{ie.checked=!1});const te=q?.querySelector(`textarea[name="person-${x}-dietary-notes"]`);te&&(te.value=""),$.querySelector(`#dietary-notes-${x}`)?.classList.add("hidden")}});const Nt=$.querySelector('input[value="other"]'),_t=$.querySelector(`#dietary-notes-${x}`);Nt?.addEventListener("change",()=>{const ct=_t?.querySelector("textarea");Nt.checked?(_t?.classList.remove("hidden"),ct&&(ct.required=!0)):(_t?.classList.add("hidden"),ct&&(ct.required=!1))}),$.querySelectorAll(`input[name="person-${x}-lodge"]`).forEach(ct=>{ct.addEventListener("change",rt)}),rr($.querySelector(`input[name="person-${x}-lodge"][value="friday"]`),[$.querySelector(`input[name="person-${x}-meal"][value="friday-dinner"]`)],rt),rr($.querySelector(`input[name="person-${x}-lodge"][value="saturday"]`),[$.querySelector(`input[name="person-${x}-meal"][value="saturday-breakfast"]`),$.querySelector(`input[name="person-${x}-meal"][value="saturday-lunch"]`)],rt),$.querySelectorAll(`input[name="person-${x}-meal"]`).forEach(ct=>{ct.addEventListener("change",rt)}),$.querySelectorAll('input[type="text"], input[type="email"], input[type="tel"], input[type="checkbox"], textarea').forEach(ct=>{ct.addEventListener("input",qe),ct.addEventListener("change",qe)}),s.appendChild($),rt(),qe()},Ue=()=>{s.innerHTML="",G=0,Jt(),rt()};r.addEventListener("click",()=>{Jt()}),Jt();const sr=()=>{const F=new FormData(t),x=[];return s.querySelectorAll(".person-form").forEach(B=>{const H=B.getAttribute("data-person-idx");if(!H)return;const q=String(F.get(`person-${H}-firstName`)??"").trim(),Nt=String(F.get(`person-${H}-lastName`)??"").trim(),_t=String(F.get(`person-${H}-email`)??"").trim(),Zt=String(F.get(`person-${H}-phone`)??"").trim(),Mt=[];B.querySelectorAll(`input[name="person-${H}-lodge"]:checked`).forEach($t=>{Mt.push($t.value)});const ct=[];ct.push("saturday-dinner"),B.querySelectorAll(`input[name="person-${H}-meal"]:checked:not([disabled])`).forEach($t=>{ct.push($t.value)});const Ft=[];B.querySelectorAll(`input[name="person-${H}-dietary"]:checked`).forEach($t=>{Ft.push($t.value)});const je=Ft.includes("other")?String(F.get(`person-${H}-dietary-notes`)??"").trim():"",mn=String(F.get(`person-${H}-notes`)??"").trim(),vt=Mt.length>0,lt={firstName:q,lastName:Nt,email:_t,phone:Zt,coming:!0,overnight:vt};Mt.length>0&&(lt.rainbowLodgeNights=Mt),ct.length>0&&(lt.meals=ct),Ft.length>0&&(lt.dietaryRestrictions=Ft),je&&(lt.dietaryNotes=je),mn&&(lt.notes=mn),x.push(lt)}),x},ir=F=>{const x={"friday-dinner":"Friday rehearsal dinner","saturday-breakfast":"Saturday breakfast","saturday-lunch":"Saturday lunch","saturday-dinner":"Saturday wedding dinner","sunday-brunch":"Sunday brunch"},$={vegetarian:"Vegetarian",vegan:"Vegan",pescatarian:"Pescatarian","dairy-free":"Dairy-free","nut-free":"Nut-free","egg-free":"Egg-free","gluten-free":"Gluten-free",other:"Other"};let B="";F.forEach(q=>{if(B+='<div class="preview-person">',B+=`<h3>${q.firstName} ${q.lastName}</h3>`,q.email&&(B+=`<p><strong>Email:</strong> ${q.email}</p>`),q.phone&&(B+=`<p><strong>Phone:</strong> ${q.phone}</p>`),q.rainbowLodgeNights&&q.rainbowLodgeNights.length>0){const _t=q.rainbowLodgeNights.map(Zt=>Zt.charAt(0).toUpperCase()+Zt.slice(1)).join(", ");B+=`<p><strong>Staying at Rainbow Lodge:</strong> ${_t}</p>`}else B+="<p><strong>Staying at Rainbow Lodge:</strong> N/A</p>";const Nt=q.meals?.filter(_t=>_t!=="saturday-dinner")||[];if(q.meals&&q.meals.length>0&&Nt.length>0){const _t=["friday-dinner","saturday-breakfast","saturday-lunch","saturday-dinner","sunday-brunch"],Zt=q.meals.sort((Mt,$e)=>_t.indexOf(Mt)-_t.indexOf($e));B+='<p><strong>Meals:</strong></p><ul style="margin: 0.25rem 0 0 1.5rem;">',Zt.forEach(Mt=>{B+=`<li>${x[Mt]||Mt}</li>`}),B+="</ul>"}else B+="<p><strong>Meals:</strong> Saturday wedding dinner only</p>";q.dietaryRestrictions&&q.dietaryRestrictions.length>0?(B+='<p><strong>Dietary Restrictions:</strong></p><ul style="margin: 0.25rem 0 0 1.5rem;">',q.dietaryRestrictions.forEach(_t=>{_t!=="other"&&(B+=`<li>${$[_t]||_t}</li>`)}),q.dietaryNotes&&(B+=`<li>${q.dietaryNotes}</li>`),B+="</ul>"):B+="<p><strong>Dietary Restrictions:</strong> N/A</p>",q.notes&&(B+=`<p><strong>Notes:</strong> ${q.notes}</p>`),B+="</div>"});const H=p();return B+=`<div class="preview-total">Total Cost: $${H}</div>`,B};t.addEventListener("submit",async F=>{if(F.preventDefault(),!!e)try{const x=sr();if(!x.some(H=>H.email&&H.phone)){Q("At least one person needs to provide email and phone");return}const B=ir(x);V.innerHTML=B,_()}catch(x){console.error(x),Q("Oops—couldn't process your response. Please try again.")}}),P.addEventListener("click",async()=>{if(e){e.disabled=!0,P.disabled=!0;try{const F=sr(),x=Date.now(),B=`${F[0]?.lastName?.toLowerCase().replace(/\s+/g,"_")||"guest"}_${x}`,H=F.map(Nt=>`${Nt.firstName} ${Nt.lastName}`).join(", "),q={familyKey:B,familyName:H,people:F};await n.saveFamilyResponse(q),T(),tt(),setTimeout(()=>{at(),Ue(),e.disabled=!1,P.disabled=!1},3e3)}catch(F){console.error(F),T(),Q("Oops—couldn't save your response. Please try again."),e.disabled=!1,P.disabled=!1}}})}const rc={"/404":"/pages/404.html","/rsvp":"/pages/rsvp.html"},sc=new wp,ic=n=>{Pp(),Dp(),Sp(n),Cp(n),Rp(sc),Ip(sc)};window.addEventListener("DOMContentLoaded",()=>{const n=document.querySelector("#app"),t=n.innerHTML,e=navigator.userAgent.toLowerCase(),r=/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini|mobile|tablet/i.test(e),s=window.innerWidth<768||window.innerHeight<600,o="ontouchstart"in window||navigator.maxTouchPoints>0,a=r||s&&o,l=new bp({onRoute:async h=>{if(a&&(h==="/"||h===""||h==="/rsvp")){n.innerHTML=`
